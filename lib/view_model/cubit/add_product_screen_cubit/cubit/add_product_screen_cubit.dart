...
class AddProductScreenCubit extends Cubit<AddProductScreenState> 
{
  ...
  TextEditingController categpryID =  TextEditingController();
    ...
    async{
     ...
     Future<void> pickImageMutiImage()
    async{
    ...
    async 
    {
        ...
        formData.files.addAll(otherImages.map((e) => MapEntry("otherImages[${otherImages.indexOf(e)}]", MultipartFile.fromFileSync(e.path))));
        await DioHelper.postData(url: "client/products", data: formData).then((value) {
